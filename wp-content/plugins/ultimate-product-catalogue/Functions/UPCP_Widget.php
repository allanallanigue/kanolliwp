...
class UPCP_Widget_Product_Search extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo "<form method='post' action='" . $instance['catalogue_url'] . "'>";
...
add_action('widgets_init', create_function('', 'return register_widget("UPCP_Widget_Product_Search");'));
