...
?>
			...
			<?php 
				...
				foreach ($Tabs_Array as $Tab_Item) { 
					echo "<tr id='upcp-tab-" . $Counter . "'>";
						echo "<td><a class='upcp-delete-tab' data-tabnumber='" . $Counter . "'>Delete</a></td>";
						echo "<td><input class='upcp-array-text-input' type='text' name='Tab_" . $Counter . "_Name' value='" . $Tab_Item['Name']. "'/></td>";
						echo "<td><textarea class='upcp-array-textarea' name='Tab_" . $Counter . "_Content'>" . $Tab_Item['Content'] . "</textarea></td>";
					echo "</tr>";
					$Counter++;
				} 
				echo "<tr><td colspan='3'><a class='upcp-add-tab' data-nextid='" . $Counter . "'>Add</a></td></tr>";
			?>
		</table>
	...
	<p class="submit"><input type="submit" name="Tabs_Submit" id="submit" class="button button-primary" value='<?php _e("Save Tabs", "UPCP")?>'/></p>
	</form>
	</div>
