...
class Easy2Map {
    ...
    public static function head() {
        ...
        $src_Easy2MapAPI = "https://maps.google.com/maps/api/js?sensor=false";
    ...
    public static function initialize() {
        ...
        load_plugin_textdomain( 'Easy2Map', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    ...
    public static function create_admin_tables() {
        ...
        if (strtolower($result) != strtolower($map_templates_table)) {
            ...
            $wpdb->query("INSERT INTO `$map_templates_table` (ID,TemplateName,ExampleImage,DisplayOrder,CSSValues,TemplateHTML,StyleParentOnly,Active,CSSValuesList,CSSValuesHeading,Version) VALUES (113,'Map Style 20 (bottom left shadow)',NULL,20,'<settings background-color=\"#FFFFFF\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" width=\"640px\" height=\"480px\"  margin-left=\"auto\" margin-right=\"auto\" />','<div align=\"center\" style=\"margin:auto;position:relative;\"><table cellpadding=\"1\" cellspacing=\"1\" id=\"divMapParent\" style=\"position:relative;\"><tr><td id=\"tdMap\" editable=\"0\" style=\"vertical-align:top;\"><div id=\"divMap\" style=\"background-color: #EBEBEB;border-style:solid;border-width:1px;border-color:transparent;top:0px;left:0px;min-width:10px;margin-bottom:5px;margin-left:5px;margin-right:5px;margin-top:5px;position:relative;\"></div><img style=\"position:absolute;bottom:-15px;left:-18px;\" src=\"[siteurl]images/map_templates/easy2map_map_shadow_left.png\" /></td></tr></table></div>',1,1,NULL,NULL,'" . self::e2m_version . "');");
            $wpdb->query("INSERT INTO `$map_templates_table` (ID,TemplateName,ExampleImage,DisplayOrder,CSSValues,TemplateHTML,StyleParentOnly,Active,CSSValuesList,CSSValuesHeading,Version) VALUES (114,'Map Style 21 (bottom right shadow)',NULL,21,'<settings background-color=\"#FFFFFF\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" width=\"640px\" height=\"480px\"  margin-left=\"auto\" margin-right=\"auto\" />','<div align=\"center\" style=\"margin:auto;position:relative;\"><table cellpadding=\"1\" cellspacing=\"1\" id=\"divMapParent\" style=\"position:relative;\"><tr><td id=\"tdMap\" editable=\"0\" style=\"vertical-align:top;\"><div id=\"divMap\" style=\"background-color: #EBEBEB;border-style:solid;border-width:1px;border-color:transparent;top:0px;left:0px;min-width:10px;margin-bottom:5px;margin-left:5px;margin-right:5px;margin-top:5px;position:relative;\"></div><img style=\"position:absolute;bottom:-15px;right:-18px;\" src=\"[siteurl]images/map_templates/easy2map_map_shadow_right.png\" /></td></tr></table></div>',1,1,NULL,NULL,'" . self::e2m_version . "');");
            ...
            if ($continue === true) {
                ...
                if (count($arrFound9) === 0) {
                   ...
                   ,CSSValuesList = '<settings max-height=\"470px\" min-width=\"200px\" padding-left=\"5px\" padding-top=\"5px\" padding-right=\"5px\" padding-bottom=\"5px\" color=\"#000000\" font-size=\"12px\" font-family=\"Arial, Helvetica, sans-serif\" background-color=\"#FFFFFF\" text-align=\"left\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" border-radius=\"0px\" />'
                   WHERE ID = 98;");
                }
                ...
                if (count($arrFound11) === 0) {
                    ...
                    ,CSSValuesList = '<settings max-height=\"200px\" padding-left=\"5px\" padding-top=\"5px\" padding-right=\"5px\" padding-bottom=\"5px\" color=\"#000000\" font-size=\"12px\" font-family=\"Arial, Helvetica, sans-serif\" background-color=\"#FFFFFF\" text-align=\"left\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" border-radius=\"0px\" />'
                    WHERE ID = 100;");
                }
                ...
                //does template 113 exist?
                $arrFound22 = $wpdb->get_results("SELECT ID FROM `$map_templates_table` WHERE ID = 113");
                if (count($arrFound22) === 0) {
                    $wpdb->query("INSERT INTO `$map_templates_table` (ID,TemplateName,ExampleImage,DisplayOrder,CSSValues,TemplateHTML,StyleParentOnly,Active,CSSValuesList,CSSValuesHeading,Version) VALUES (113,'Map Style 20 (drop left shadow)',NULL,20,'<settings background-color=\"#FFFFFF\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" width=\"640px\" height=\"480px\"  margin-left=\"auto\" margin-right=\"auto\" />','<div align=\"center\" style=\"margin:auto;position:relative;\"><table cellpadding=\"1\" cellspacing=\"1\" id=\"divMapParent\" style=\"position:relative;\"><tr><td id=\"tdMap\" editable=\"0\" style=\"vertical-align:top;\"><div id=\"divMap\" style=\"background-color: #EBEBEB;border-style:solid;border-width:1px;border-color:transparent;top:0px;left:0px;min-width:10px;margin-bottom:5px;margin-left:5px;margin-right:5px;margin-top:5px;position:relative;\"></div><img style=\"position:absolute;bottom:-15px;left:-18px;\" src=\"[siteurl]images/map_templates/easy2map_map_shadow_left.png\" /></td></tr></table></div>',1,1,NULL,NULL,'" . self::e2m_version . "');");
                }

                //does template 114 exist?
                $arrFound23 = $wpdb->get_results("SELECT ID FROM `$map_templates_table` WHERE ID = 114");
                if (count($arrFound23) === 0) {
                    $wpdb->query("INSERT INTO `$map_templates_table` (ID,TemplateName,ExampleImage,DisplayOrder,CSSValues,TemplateHTML,StyleParentOnly,Active,CSSValuesList,CSSValuesHeading,Version) VALUES (114,'Map Style 21 (drop right shadow)',NULL,21,'<settings background-color=\"#FFFFFF\" border-style=\"solid\" border-width=\"1px\" border-color=\"#EBEBEB\" width=\"640px\" height=\"480px\"  margin-left=\"auto\" margin-right=\"auto\" />','<div align=\"center\" style=\"margin:auto;position:relative;\"><table cellpadding=\"1\" cellspacing=\"1\" id=\"divMapParent\" style=\"position:relative;\"><tr><td id=\"tdMap\" editable=\"0\" style=\"vertical-align:top;\"><div id=\"divMap\" style=\"background-color: #EBEBEB;border-style:solid;border-width:1px;border-color:transparent;top:0px;left:0px;min-width:10px;margin-bottom:5px;margin-left:5px;margin-right:5px;margin-top:5px;position:relative;\"></div><img style=\"position:absolute;bottom:-15px;right:-18px;\" src=\"[siteurl]images/map_templates/easy2map_map_shadow_right.png\" /></td></tr></table></div>',1,1,NULL,NULL,'" . self::e2m_version . "');");
                }

                //set all old templates to ZERO
                $wpdb->query("UPDATE `$map_templates_table` SET `Active` = 0 WHERE ID NOT IN (94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114);");
                $wpdb->query("UPDATE `$map_templates_table` SET `Active` = 1 WHERE ID IN (94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,107,108,109,110,111,112,113,114);");
                //set all maps to default template
                $wpdb->query("UPDATE `$map_table` SET `TemplateID` = 94 WHERE `TemplateID` NOT IN (94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,107,108,109,110,111,112,113,114);");
