            ...
            switch (attribute) {
                ...
                case "border_width":
                {
                    ...
                    case "max_height":
                    {
                        ...
                        jQuery('#tdheading_pixel').html("Maximum Height");
                        //jQuery('#txtDefaultValue_pixel').find('option').remove();
                        //for (var i = parseInt(10); i <= parseInt(2000); i++)
                        //    jQuery('#txtDefaultValue_pixel').append('<option value="' + i + '">' + i + '</option>');
                        jQuery('#div_edit_pixel').modal();
                    ...
                    case "max_width":
                    {
                        ...
                        jQuery('#tdheading_pixel').html("Maximum Width");
                        //jQuery('#txtDefaultValue_pixel').find('option').remove();
                        //for (var i = parseInt(10); i <= parseInt(2000); i++)
                        //    jQuery('#txtDefaultValue_pixel').append('<option value="' + i + '">' + i + '</option>');
                        jQuery('#div_edit_pixel').modal();
                    ...
                    case "min_width":
                    {
                        ...
                        jQuery('#tdheading_pixel').html("Minimum Width");
                        //jQuery('#txtDefaultValue_pixel').find('option').remove();
                        //for (var i = parseInt(10); i <= parseInt(2000); i++)
                        //    jQuery('#txtDefaultValue_pixel').append('<option value="' + i + '">' + i + '</option>');
                        jQuery('#div_edit_pixel').modal();
                    ...
                    case "padding_bottom":
                    {
                        ...
                        jQuery('#tdheading_margin').html("Bottom Padding");
                        jQuery('#txtDefaultValue_margin').find('option').remove();
                        jQuery('#txtDefaultValue_margin').append('<option value="auto">auto</option>');
                        for (var i = parseInt(0); i <= parseInt(500); i++)
                            jQuery('#txtDefaultValue_margin').append('<option value="' + i + '">' + i + '</option>');
                    ...
                    case "padding_top":
                    {
                        ...
                        jQuery('#tdheading_margin').html("Top Padding");
                        jQuery('#txtDefaultValue_margin').find('option').remove();
                        jQuery('#txtDefaultValue_margin').append('<option value="auto">auto</option>');
                        for (var i = parseInt(0); i <= parseInt(500); i++)
                            jQuery('#txtDefaultValue_margin').append('<option value="' + i + '">' + i + '</option>');
                    ...
                    case "padding_left":
                    {
                        ...
                        jQuery('#tdheading_margin').html("Left Padding");
                        jQuery('#txtDefaultValue_margin').find('option').remove();
                        jQuery('#txtDefaultValue_margin').append('<option value="auto">auto</option>');
                        for (var i = parseInt(0); i <= parseInt(500); i++)
                            jQuery('#txtDefaultValue_margin').append('<option value="' + i + '">' + i + '</option>');
                    ...
                    case "padding_right":
                    {
                        ...
                        jQuery('#tdheading_margin').html("Right Padding");
                        jQuery('#txtDefaultValue_margin').find('option').remove();
                        jQuery('#txtDefaultValue_margin').append('<option value="auto">auto</option>');
                        for (var i = parseInt(0); i <= parseInt(500); i++)
                            jQuery('#txtDefaultValue_margin').append('<option value="' + i + '">' + i + '</option>');
